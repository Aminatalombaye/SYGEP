    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.attributions.update", [$attribution->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nom') ? 'is-invalid' : '' }}" type="text" name="nom" id="nom" value="{{ old('nom', $attribution->nom) }}">
                @if($errors->has('nom'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('type_atribution') ? 'is-invalid' : '' }}" type="text" name="type_atribution" id="type_atribution" value="{{ old('type_atribution', $attribution->type_atribution) }}">
