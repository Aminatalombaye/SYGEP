...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.inventaires.update", [$inventaire->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="in">{{ trans('cruds.inventaire.fields.in') }}</label>
                <input class="form-control {{ $errors->has('in') ? 'is-invalid' : '' }}" type="text" name="in" id="in" value="{{ old('in', $inventaire->in) }}">
                @if($errors->has('in'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('out') ? 'is-invalid' : '' }}" type="text" name="out" id="out" value="{{ old('out', $inventaire->out) }}">
                @if($errors->has('out'))
                    <div class="invalid-feedback">
                        {{ $errors->first('out') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('balance') ? 'is-invalid' : '' }}" type="text" name="balance" id="balance" value="{{ old('balance', $inventaire->balance) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('reference') ? 'is-invalid' : '' }}" type="text" name="reference" id="reference" value="{{ old('reference', $inventaire->reference) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nom') ? 'is-invalid' : '' }}" type="text" name="nom" id="nom" value="{{ old('nom', $inventaire->nom) }}">
                @if($errors->has('nom'))
                    <div class="invalid-feedback">
                        {{ $errors->first('nom') }}
                    </div>
